 ...
 */
/*                                      Mask,   Comparator */
#define L4_Info_Uncached            {0xffff,    ARCH_CACHE_ATTRIB_UNCACHED}
#define L4_Info_Cached              {0x0000,    ARCH_CACHE_ATTRIB_CACHED}
#define L4_Info_IOMemory            {0x0000,    0x0f}
#define L4_Info_IOMemoryShared      {0x0000,    0x0f}
#define L4_Info_WriteThrough        {0xffff,    ARCH_CACHE_ATTRIB_WRITETHROUGH}
#define L4_Info_WriteBack           {0xffff,    ARCH_CACHE_ATTRIB_WRITEBACK}
#define L4_Info_Shared              {0x0080,    ARCH_CACHE_ATTRIB_SHARED}
